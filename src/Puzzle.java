...
/**
 * JAVAFX DESCRIPTION:<br>
 * For the correct work of program it is necessary download and install JavaFX application.<br>
 * File - Project Structure - Libraries - From Maven, in the searching line type fx,<br>
 * Choose from the list org.openjfx:javafx-fxml:19.0.2<br>
 * In Run - Edit Configurations - VM options write<br>
 * --module-path "/Users/pras/IdeaProjects/Puzzle15/lib" --add-modules javafx.controls,javafx.fxml<br>
 * --module-path "C:\Users\Chous\IdeaProjects\Puzzle15\lib" --add-modules javafx.controls,javafx.fxml<br>
 */
